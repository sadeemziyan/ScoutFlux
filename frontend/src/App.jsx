        ...
        return (
          <li key={item.id} className="relative">
            ...
            <button
              ...
              className={`w-full text-left pl-3 pr-2 py-1.5 rounded-control text-[0.875rem]
                transition-colors duration-150
                ${active ? 'font-medium text-ink bg-row-selected' : 'text-slate hover:text-ink hover:bg-row-hover'}`}
            >
              {item.label}
            </button>
          </li>
...
function App() {
  ...
  return (
    <div className="min-h-dvh lg:grid lg:grid-cols-[16rem_minmax(0,1fr)]">
      ...
      <div className="lg:hidden border-b border-rule bg-canvas sticky top-0 z-10">
        <div className="flex items-center justify-between gap-3 px-4 h-14">
          ...
          <button
            ...
            className="text-[0.875rem] font-medium text-slate hover:text-ink px-2 py-1 rounded-control"
          >
      ...
      >
        ...
        <div className="mt-8 lg:mt-auto lg:pt-6">
          <div className="border-t border-rule pt-4">
            <p className="text-[0.8125rem] text-slate truncate" title={userEmail || ''}>
              {userEmail}
            </p>
            <Button
              variant="quiet"
      ...
      <main className="px-5 sm:px-8 lg:px-10 py-7 lg:py-9 max-w-[56rem] w-full">
        ...
        {view === 'form' && submitStatus === 'loading' && (
          <div className="max-w-lg">
            <h1 className="font-serif text-[1.3125rem] font-semibold text-ink mb-2">
        ...
        {view === 'form' && submitStatus === 'error' && (
          <div className="max-w-lg space-y-4">
            <h1 className="font-serif text-[1.3125rem] font-semibold text-ink">
